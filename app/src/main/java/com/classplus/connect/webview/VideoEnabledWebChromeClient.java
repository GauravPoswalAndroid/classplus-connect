package com.classplus.connect.webview;
...
public class VideoEnabledWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
    ...
    public ValueCallback<Uri[]> fileReceivedMessageAboveL;
    public ValueCallback<Uri> fileReceivedMessage;
    ...
    /**
     * This sets a callback to open the android native File chooser from hosting activity itself
     * when there is a file selection action triggered from web page.
     *
     * @param callback A VideoEnabledWebChromeClient.FileSelectionCallback callback
     */
    @SuppressWarnings("unused")
    public void setFileSelectionCallback(FileSelectionCallback callback) {
    ...
    public void openFileChooser(ValueCallback<Uri> valueCallback, String acceptType, String capture) {
        if (fileSelectionCallback != null) {
            fileReceivedMessage = valueCallback;
            fileSelectionCallback.openFileSelectionActivity();
        }
    }
    ...
    public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
        if (fileSelectionCallback != null) {
            fileReceivedMessageAboveL = filePathCallback;
            fileSelectionCallback.openFileSelectionActivity(fileChooserParams);
            return true;
        }
        return false;
    }
    ...
    public interface FileSelectionCallback {
        void openFileSelectionActivity();

        void openFileSelectionActivity(FileChooserParams fileChooserParams);
    }
}